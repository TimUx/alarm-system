...
title_sprite.SetPosition(Window.GetWidth()/2 - (title_image.GetWidth() * title_scale)/2, Window.GetHeight()/2 - 90, 10000);
...
subtitle_sprite.SetPosition(Window.GetWidth()/2 - (subtitle_image.GetWidth() * subtitle_scale)/2, Window.GetHeight()/2 + 30, 10000);
PLYMSCRIPT
