...
title_sprite.SetXScale(3.0);
title_sprite.SetYScale(3.0);
title_sprite.SetPosition(Window.GetWidth()/2 - (title_image.GetWidth() * 3.0)/2, Window.GetHeight()/2 - 90, 10000);

subtitle_image = Image.Text("Bitte warten...", 0.8, 0.8, 0.8);
subtitle_sprite = Sprite();
subtitle_sprite.SetImage(subtitle_image);
subtitle_sprite.SetXScale(2.0);
subtitle_sprite.SetYScale(2.0);
subtitle_sprite.SetPosition(Window.GetWidth()/2 - (subtitle_image.GetWidth() * 2.0)/2, Window.GetHeight()/2 + 30, 10000);
PLYMSCRIPT
